...
local imageUnder = binarch.newImageRect( mainGroup, "balloon.jpg", 360, 570 )
...
local imageOver = binarch.newImageRect( "back-darkgrey.png", 360, 640 )
snapshot.canvas:insert( imageOver )
snapshot:invalidate( "canvas" )

local o = binarch.newImageRect( "eraser.png", 64, 64 )
	o.x = display.contentWidth * 2
	o.y = display.contentHeight * 2
