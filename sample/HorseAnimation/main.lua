...
-- Modified to use Binary Archive Module
---------------------------------------------------------------------------------------
...
local background = binarch.newImage( sceneContainer, "background.png", 0, 0 )

local moon = binarch.newImage( sceneContainer, "moon.png", 22, 19 )

local mountain_big = binarch.newImage( sceneContainer, "mountain_big.png", 132-240, 92 )
local mountain_big2 = binarch.newImage( sceneContainer, "mountain_big.png", 132-720, 92 )
local mountain_sma = binarch.newImage( sceneContainer, "mountain_small.png", 84, 111 )
local mountain_sma2 = binarch.newImage( sceneContainer, "mountain_small.png", 84-480, 111 )

local tree_s = binarch.newImage( sceneContainer, "tree_s.png", 129-30, 151 )
local tree_s2 = binarch.newImage( sceneContainer, "tree_s.png", 270+10, 151 )
local tree_l = binarch.newImage( sceneContainer, "tree_l.png", 145, 131 )

local tree_s3 = binarch.newImage( sceneContainer, "tree_s.png", 129-30-320, 151 )
local tree_s4 = binarch.newImage( sceneContainer, "tree_s.png", 270+10-320, 151 )
local tree_l2 = binarch.newImage( sceneContainer, "tree_l.png", 145-320, 131 )

local tree_s5 = binarch.newImage( sceneContainer, "tree_s.png", 129-30-640, 151 )
local tree_s6 = binarch.newImage( sceneContainer, "tree_s.png", 270+10-640, 151 )
local tree_l3 = binarch.newImage( sceneContainer, "tree_l.png", 145-640, 131 )

-- Create two fog pieces and scale horizontally by slight amount to prevent "seam" between each piece
local fog = binarch.newImage( sceneContainer, "fog.png", 240, 214 )
fog.xScale = 1.001
local fog2 = binarch.newImage( sceneContainer, "fog.png", -240, 214 )
fog2.xScale = 1.001
...
local umaSheet = binarch.newImageSheet( "uma.png", options )
...
local tree_l_sugi = binarch.newImage( sceneContainer, "tree_l_sugi.png", 23, 0 )
local tree_l_take = binarch.newImage( sceneContainer, "tree_l_take.png", 151, 0 )

local rakkan = binarch.newImage( sceneContainer, "rakkan.png", 19, 217 )
local rakkann = binarch.newImage( sceneContainer, "rakkann.png", 450, 11 )
