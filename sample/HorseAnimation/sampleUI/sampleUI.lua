...
function M:newUI( options )
	...
	local background = binarch.newImageRect( backGroup, "sampleUI/back-" .. themeName .. ".png", 360, 640 )
	...
	self.appFont = native.systemFont
	...
	local infoButton = binarch.newImageRect( barContainer, "sampleUI/infobutton.png", 25, 25 )
